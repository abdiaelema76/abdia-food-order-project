        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/cfc.png" alt=""> </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">Home <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php">Restaurant branch <span class="sr-only"></span></a> </li>
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;"></span>Choose Restaurant branch</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span style="color:white;"></span>Order Food</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color:white;"></span>Dine In or take out</h4> </div>
        ...
        <section class="how-it-works">
            <div class="container">
                <div class="text-xs-center">
                    <h2><span style="color:blue;" ></span>WELCOME TO CARIBBEAN FOOD COURT</h2>
                    <div class="row how-it-works-solution">
                       <p> <span style="color:blue;" ></span>It is pleasure and honour to have you as guest</p>
                </div>
                <div class="row">
